    ...
    <center>
        ...
        <div class="col-md-6 m-3" style="padding-bottom: 10em;">
            ...
            <header class="text-center mt-4">
                <p class="lead">Solicitud de medicamento</p>
            </header>
            <form class="form-signin mt-4" action="solicitud.php" method="POST">
                <div class="contenedor">
                    ...
                    <div class="row">
                        ...
                        <div class="col-8">
                            <div class="form-floating">
                                ...
                                <label for="cedula" class="form-label">Nombre del producto</label>
                            </div>
                        ...
                        <div class="col-4">
                            <div class="form-floating">
                                <select class="form-select form select-lg mb-3" name="tipocedula">
                                    <option value="V">Pastillas</option>
                                    <option value="E">Crema</option>
                                </select>
                                <label for="cedula" class="form-label">Presentación</label>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="form-floating">
                                ...
                                <label for="nombre" class="form-label">Concentración</label>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="form-floating">
                                <input type="text" class="form-control" name="apellido" id="apellido">
                                <label for="apellido" class="form-label">Cantidad</label>
                            </div>
                        </div>
                    ...
                    <div class="form-floating">
                        ...
                        <label for="telefono" class="form-label">Solicitante</label>
                    </div>
                    <div class="form-floating">
                        <input type="email" class="form-control" name="correo" id="correo">
                        <label for="correo" class="form-label">Teléfono solicitante (si aplica)</label>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-sm-5">
                            <div class="form-floating">
                                <select class="form-select form select-lg mb-3" name="tipo_beneficiario">
                                    <option value="1">Funcionario</option>
                                    <option value="2">Familiar</option>
                                </select>
                                <label for="tipo_beneficiario" class="form-label">Tipo beneficiario</label>
                            </div>
                        </div>
                        <div class="col-sm-7">
                            <div class="form-floating">
                                <input type="text" class="form-control" name="dept" id="departamento">
                                <label for="departamento" class="form-label">Funcionario</label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="select2">
                        <?php include 'selectFuncionario.php'; ?>
                    </div>
